...
function AddAdmin() {
  ...
  const handleRegister = () => {
    axios
      .post(
        mainUrl + "/api/admin/create/admin",
        {
          userName,
          password,
          name,
      ...
      .catch((error) => {
        if (error.response.status >= 400) {
          toast.error(
            error.response.data.message.split("admins validation failed:")[1],
            {
              position: "top-right",
              autoClose: 2000,
              hideProgressBar: false,
  ...
  return (
    <Container>
      ...
      <Row className="justify-content-md-center mt-4">
        <Col md={6}>
          <h2 className="text-center">Yangi Admin qo'shish</h2>
          ...
          <Form>
            ...
            <Form.Group controlId="formBasicName">
              <Form.Label>Admin Ismi</Form.Label>
              <Form.Control
                type="text"
                value={name}
            ...
            <Form.Group controlId="formBasicUSurname">
              <Form.Label>Admin Familiyasi</Form.Label>
              <Form.Control
                type="text"
                value={surname}
